...
var data = [
    {name: "Adam ", twitterHandle: "@horse",createdAt:'2018-05-31',tweet: "How to Get Rich (without getting lucky) 1",image:'http://placekitten.com/g/200/300'}, 
    {name: "Kate ", twitterHandle: "@cat",createdAt:'2018-05-31',tweet: "How to Get Rich (without getting lucky) 2",image:'http://placekitten.com/g/200/300'}, 
    {name: "Jenny ", twitterHandle: "@squirrel",createdAt:'2018-05-31',tweet: "How to Get Rich (without getting lucky) 3",image:'http://placekitten.com/g/200/300'},
    ]
    ...
    data.forEach(function(obj){
      //This is just creating the skeleton
              ...
              let parent1=document.querySelector('div1');
              let p1=document.createElement('p'); //sibling of div2
              p1.textContent=obj.tweet
              div1.insertBefore(p1, div1.firstElementChild.nextSibling)//insertafter() property is there
              //sibling of div2 attached
             
              let image=document.createElement('img')
              image.src=obj.image
              div2.appendChild(image)
              let parent2=document.querySelector('div2')
              const div3=document.createElement('div')
              div2.insertBefore(div3, div2.firstElementChild.nextSibling)
              const h3=document.createElement('h3')
              div3.appendChild(h3)
              let parent3=document.querySelector('div3')
